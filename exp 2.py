...
def train_naive_bayes(freqs, train_x, train_y):
    ...
    for word in vocab:
        ...
        # calculate the probability that each word is positive, and negative (with Laplace smoothing)
...
def naive_bayes_predict(tweet, logprior, loglikelihood):
    ...
    # initialize probability with logprior
    p = logprior
...
def get_ratio(freqs, word):
    ...
    # calculate the ratio of positive to negative counts for the word (with smoothing)
    pos = pos_neg_ratio['positive']
    neg = pos_neg_ratio['negative']
    pos_neg_ratio['ratio'] = (pos + 1) / (neg + 1)
    ### END CODE HERE ###
...
def get_words_by_threshold(freqs, label, threshold, get_ratio=get_ratio):
    ...
    for key in freqs.keys():
        ...
        # otherwise, do not include this word in the list
    ### END CODE HERE ###
    return word_list
